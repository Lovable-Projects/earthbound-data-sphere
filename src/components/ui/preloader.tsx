    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      <div className="absolute z-10 left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 pointer-events-none flex flex-col justify-center items-center">
        <motion.h1 
          ...
          className="text-4xl md:text-6xl font-light mb-4 tracking-widest text-primary whitespace-nowrap"
        >
          Perssonify
        </motion.h1>
        <motion.p 
          ...
          className="text-sm md:text-base text-muted-foreground font-mono tracking-wide pointer-events-none mb-8"
        >
