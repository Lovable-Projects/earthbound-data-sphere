...
const CTASection: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-home-gradient transition-colors relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10 relative z-10">
        ...
        >
          ...
          >
            <Button asChild size="lg" variant="default" className="group mb-12">
              <Link to="/contact">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {ctaOptions.map((option, index) => (
            <motion.div
              ...
              className="bg-card/80 dark:bg-card/60 border border-border backdrop-blur-sm rounded-2xl p-8 text-center hover:bg-muted/60 transition-all duration-300 hover:-translate-y-2 flex flex-col justify-between"
            >
              <div>
