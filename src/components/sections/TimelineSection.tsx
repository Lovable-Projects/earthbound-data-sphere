            ...
            <section id="growth-solutions" className="py-8 mb-12 sm:mb-16">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-6">
                <div className="flex items-start gap-3 p-4 rounded-lg border bg-card">
                  <img src="/Icons/1.svg" alt="Performance Marketing" className="w-5 h-5 mt-1 text-primary flex-initial color-primary" />
                  <div>
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg border bg-card">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 390 430" className="w-8 h-8 text-primary">
                    ...
                    <path stroke="url(#c)" d="M238.03 202.145c0 4.792 3.885 8.677 8.677 8.677s8.676-3.885 8.676-8.677-3.884-8.676-8.676-8.676-8.677 3.884-8.677 8.676Z" />
                    <defs>
                      <radialGradient id="a" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(327.6666564941406 142.66665649414062) rotate(45) scale(166 180)"><stop stopColor="hsl(var(--brand-default))" /><stop offset="1" stopColor="hsl(var(--foreground-lighter))" /></radialGradient>
                      <radialGradient id="b" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(327.6666564941406 142.66665649414062) rotate(45) scale(166 180)"><stop stopColor="hsl(var(--brand-default))" /><stop offset="1" stopColor="hsl(var(--foreground-lighter))" /></radialGradient>
                      <radialGradient id="c" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(327.6666564941406 142.66665649414062) rotate(45) scale(166 180)"><stop stopColor="hsl(var(--brand-default))" /><stop offset="1" stopColor="hsl(var(--foreground-lighter))" /></radialGradient>
                    </defs>
                  </svg>
                  <div>
